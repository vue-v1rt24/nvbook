...
import { type TypeWorkPortfolio } from '@/types/home-page/works.types';
...
const viewReview = () => {
  if (props.dataWork.review.reviewZagruziteFajl?.node.mediaItemUrl) {
    Fancybox.show([
      {
